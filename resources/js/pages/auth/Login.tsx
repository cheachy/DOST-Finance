            ...
            <aside className="aslr-cover">
                ...
                <div className="aslr-cover__center">
                    ...
                    <div className="aslr-cover__stats">
                        <div>
                            <span className="aslr-cover__stat-key">
                                Efficiency
                            </span>
                            <span className="aslr-cover__stat-val">
                ...
                <span className="aslr-cover__vertical">
            ...
            <main className="aslr-panel">
                <div className="aslr-panel__body">
                    <div className="aslr-panel__head">
                        ...
                        <div>
                            ...
                            <p className="aslr-panel__org-sub">
                                Regional Office XIII
                            </p>
                        </div>
                    </div>

                    <h1 className="aslr-panel__title">
                        Automated Subsidiary Ledger and Report
                    </h1>
                    <p className="aslr-panel__lede">
                        Secure ledger accounting, fund tracking, and compliance
                        automation
                    </p>
                    ...
                    <form onSubmit={submit} className="aslr-form">
                        <div className="aslr-field">
                            ...
                            <div className="aslr-input">
                                <span className="aslr-input__icon">
                                    <IUser />
                                </span>
                                <input
                                    id="email"
              ...
              <span className="aslr-ver">Ver. 2026.1</span>
                ...
                <footer className="aslr-panel__foot">
                    <p>
                        Official Internal System of the Department of Science
                        and Technology - CARAGA Region. Unauthorized access is
                        strictly prohibited and subject to legal action under
                        R.A. 10175.
                    </p>
                </footer>
            </main>
